...
<section class="page-title" style="background-image: url(<?php echo e(asset('public/front_website/images/background/about-us-banner.jpg'), false); ?>);">
    <div id="stars"></div>
    <div id="stars2"></div>
    <div id="stars3"></div>
...
<section class=" over_page mt-5">
 <!-- <div class="team-bg wow fadeInRight">
  <img src="<?php echo e(asset('public/front_website/images/background/3.png'), false); ?>" />
 </div> -->
...
<?php echo $__env->make('front_website.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahitechno.com/resources/views/front_website/page/about.blade.php ENDPATH**/ ?>