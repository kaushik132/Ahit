  ...
  <div class="row">
    ...
    <div class="col-md-9 mt-2">
      <div class="order-searchboxves">
          <form method="get" action="{{route('searchwishlist')}}" class="d-flex">
...
@endphp
        ...
        <a href="{{url('single-product/'. $slug)}}" style="text-decoration: none;">
      <div class="order-searchboxves mt-3">
        <div class="orders-listshow">
           <div class="d-flex">
            <div><img src="https://ahitechno.com/public/front_website/images/logo.png" alt="order-image" class="img-fluid order-image-img"></div>
            <div class="ms-3 order-delvry-dtlssz">
              <h6 class="text-dark">{{ $details['title']}}</h6>
              {{-- <p><b>Color : {{ $details->productCategory['name'] }}</b></p> --}}
            </div>
          </div>

          <h5 class="mt-3"><i class="bi bi-currency-rupee"></i>{{ $details['fixprice']}}</h5>
{{-- 
          <div class="order-delvry-dtlssz">
            <h6 style="color:rgb(51, 151, 84);">Select on Apr 3</h6>
