...
<head>
   ...
   @endif
   @if(isset($seo_data['keywords']))
   <meta property="og:keywords" content="{{$seo_data['keywords']}}">
   @endif
   ...
   <link href="{{asset('public/front_website/css/bootstrap.css')}}" rel="stylesheet">
   <link href="{{asset('public/front_website/css/style.css')}}" rel="stylesheet">
   <link href="{{asset('public/front_website/css/mouse-style.css')}}" rel="stylesheet">
   <link href="{{asset('public/front_website/css/responsive.css')}}" rel="stylesheet">
   <link href="{{asset('public/front_website/css/color-switcher-design.css')}}" rel="stylesheet">
   <link id="theme-color-file" href="{{asset('public/front_website/css/color-themes/default-theme.css')}}" rel="stylesheet">
   ...
   <link href="{{asset('public/front_website/csss/project.css')}}" rel="stylesheet" />
   <link href="{{asset('public/front_website/csss/addtocart.css')}}" rel="stylesheet" />
   <link href="{{asset('public/front_website/csss/buynow.css')}}" rel="stylesheet" />
   <link href="{{asset('public/front_website/csss/signup.css')}}" rel="stylesheet" />
   ...
   <div class="g-review-fixed" id="review-fixed">
      <a href="https://www.google.com/maps/place/AHIT/@26.9435346,75.8382529,15z/data=!4m6!3m5!1s0x396db1e7df1a454b:0xb3adbed6fbff8677!8m2!3d26.9435346!4d75.8382529!16s%2Fg%2F11rsrf40wl?entry=ttu" target="_blank">
         <img src="{{url('front_website/images/google-review.png')}}" alt="google review">
      </a>
   </div>
...
<body>
   ...
   <header class="main-header header-style-three" style="box-shadow: 0 0 15px rgba(var(--black-opicity),.10);z-index:3000;">
            ...
            <div class="header-lower">
               <div class="main-box clearfix">
                  <div class="logo-box desk-logovw">
                     <div class="logo"><a href="{{route('home')}}"><img src="{{url('public/front_website/images/ahitlogo.png')}}" alt="logo" title="" class="img-fluid" style="width:100px;"></a></div>
                  </div>
                           ...
                           <ul class="navigation clearfix">
                              ...
                              <li class="dropdown mt-2">
                                 ...
                                 <!-- <li><a href="">All Services</a></li> -->
                                    @foreach($itServices as $services)
                                    <li><a href="{{ url('it-services/' . $services->slug) }}">{{$services->name}}</a></li>
                                    @endforeach
                              ...
                              <li class="mt-2">
                                 <a href="{{route('products')}}">IT Product </a>
                              ...
                              <li class="mt-2"><a href="{{route('contact-us')}}">Contact</a></li>
                              ...
                              <li class="mt-2">
                                 <a href="{{route('add-to-cart')}}"><span class="fa fa-cart-plus header-icn-vw " style="position:relative"></span>
                              ...
                              <li class="dropdown">
                                 ...
                                 @if (Auth::check())
                                 <a href="javascript:void(0)"><img src="{{url('front_website/images/user.png')}}" alt="User" class="user-hm-logo" /></a>
                                 <h6 style="cursor:pointer;font-size:15px;font-weight:500">{{ Auth::user()->fname ?? ""}} {{ Auth::user()->lname ?? ""}}</h6>
                                 <ul class="drop-menu-typ">
                                <a href="{{url('profile/'.Auth::user()->id)}}"><button class=""  style="background:#1e748f;border:none; padding:10px;font-size:16px;color:white;width:100%">Profile</button></a>
                                 ...
                                 <li><a href="{{route('signpage')}}">Sign Up</a></li>
                                 </ul>
                                 @endif
      ...
      <div class="mobile-menu">
         ...
         <nav class="menu-box">
            <div class="nav-logo"><a href="{{route('home')}}"><img src="{{asset('public/front_website/images/logo.png')}}" alt="" title=""></a></div>
   ...
   <footer class="footer-bgclr">
      ...
      <div class="container-fluid">
         <div class="row">
            <div class="col-md-3">
               ...
               <ul class="footer-list-fnt">
                  <li class="mt-3">
                     <a href="{{route('about-us')}}"><i class="bi bi-chevron-right"></i>About Us</a>
                  </li>
                  <li class="mt-3"> <a href="{{route('contact-us')}}"><i class="bi bi-chevron-right"></i>Contact Us</a></li>
                  <li class="mt-3"> <a href="{{route('privacy')}}"><i class="bi bi-chevron-right"></i>Privacy Policy</a></li>
                  <li class="mt-3"><a href="{{route('terms')}}"><i class="bi bi-chevron-right"></i>Terms & Conditions</a></li>
                  <li class="mt-3"><a href="{{route('shipping')}}"><i class="bi bi-chevron-right"></i>Shipping Policy</a></li>
                  <li class="mt-3"><a href="{{route('cancellation')}}"><i class="bi bi-chevron-right"></i>Cancellation & Refund Policy</a></li>
            ...
            <div class="col-md-3">
               <ul class="footer-list-fnt">
                  <li class="mt-3">
                     <a href="{{url('it-services/web-design')}}"><i class="bi bi-chevron-right"></i>Web Design</a>
                  </li>
                  <li class="mt-3"> <a href="{{url('it-services/graphic-design')}}"><i class="bi bi-chevron-right"></i>Graphic Design</a></li>
                  <li class="mt-3"> <a href="{{url('it-services/web-development')}}"><i class="bi bi-chevron-right"></i>Web Development</a></li>
                  <li class="mt-3"><a href="{{url('it-services/digital-marketing')}}"><i class="bi bi-chevron-right"></i>Digital Marketing</a></li>
                  <li class="mt-3"><a href="{{url('it-services/e-commerce')}}"><i class="bi bi-chevron-right"></i>E-Commerce</a></li>
                  <li class="mt-3"><a href="{{url('it-services/photography')}}"><i class="bi bi-chevron-right"></i>Photography</a></li>
            ...
            <div class="col-md-3">
               <ul class="footer-list-fnt">
                  <li class="mt-3">
                     <a href="{{route('products')}}"><i class="bi bi-chevron-right"></i>IT Product</a>
                  </li>
                  <li class="mt-3"> <a href="{{route('projects')}}"><i class="bi bi-chevron-right"></i>Projects</a></li>
                  <li class="mt-3"> <a href="{{route('blogs')}}"><i class="bi bi-chevron-right"></i>Blogs</a></li>
                  <li class="mt-3"><a href="{{route('quotation')}}"><i class="bi bi-chevron-right"></i>Get Quotation</a></li>
         ...
         <div class="footer-bottom-box">
            <p style="margin-bottom:0px;color:white;font-size:13px;font-weight:400;letter-spacing:0.75px">Copyright © {{date('Y')}} AHIT <a href="javascript:void(0)"></a> All right reserved</p>
   ...
   <script src="{{asset('public/front_website/js/jquery.js')}}"></script>
   <script src="{{asset('public/front_website/js/popper.min.js')}}"></script>
   <!-- <script src="{{asset('public/front_website/js/bootstrap.min.js')}}"></script>  -->

   <!-- <script src="{{asset('public/front_website/js/bootstrap.bundle.min.js')}}"></script> -->
   <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-geWF76RCwLtnZ8qwWowPQNguL3RmwHVBC9FhGdlKrxdiJJigb/j/68SIy3Te4Bkz" crossorigin="anonymous"></script>

   <script src="{{asset('public/front_website/js/jquery.fancybox.js')}}"></script>
   <script src="{{asset('public/front_website/js/appear.js')}}"></script>
   <script src="{{asset('public/front_website/js/jquery.mCustomScrollbar.concat.min.js')}}"></script>
   <script src="{{asset('public/front_website/js/nav-tool.js')}}"></script>
   <script src="{{asset('public/front_website/js/jquery-ui.js')}}"></script>
   <script src="{{asset('public/front_website/js/parallax.min.js')}}"></script>
   <script src="{{asset('public/front_website/js/tilt.jquery.min.js')}}"></script>
   <script src="{{asset('public/front_website/js/jquery.paroller.min.js')}}"></script>
   <script src="{{asset('public/front_website/js/owl.js')}}"></script>
   <script src="{{asset('public/front_website/js/mixitup.js')}}"></script>
   <script src="{{asset('public/front_website/js/wow.js')}}"></script>
   <script src="{{asset('public/front_website/js/script.js')}}"></script>
   <script src="{{asset('public/front_website/js/color-settings.js')}}"></script>
...
<script>
function myService() {
  location.replace("{{ url('it-service') }}")
}
</script>
